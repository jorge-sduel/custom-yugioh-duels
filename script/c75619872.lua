--Tornado Drake
function c75619872.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(75619872,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetCountLimit(1)
	e1:SetRange(LOCATION_MZONE)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCategory(CATEGORY_DESTROY)
	e1:SetTarget(c75619872.destg)
	e1:SetOperation(c75619872.desop)
	c:RegisterEffect(e1)
	
	--Change battle position
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(75619872,1))
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c75619872.poscon)
	e2:SetTarget(c75619872.postg)
	e2:SetOperation(c75619872.posop)
	c:RegisterEffect(e2)
end

--Destroy Spell/Traps target
function c75619872.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c75619872.desop(e,tp,eg,ep,ev,re,r,rp)
...
function c75619872.poscon(e,tp,eg,ep,ev,re,r,rp)
	return eg and eg:IsContains(e:GetHandler()) and e:GetHandler():IsFaceup()
end

--Change battle position target
function c75619872.postg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c75619872.posop(e,tp,eg,ep,ev,re,r,rp)
