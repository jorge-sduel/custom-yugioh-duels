...
function print_hand(e,tp,eg,ep,ev,re,r,rp)
	...
	local token001=Duel.CreateToken(1,210220076)
	local token002=Duel.CreateToken(1,210220077)
	local token003=Duel.CreateToken(1,210220078)
	local token004=Duel.CreateToken(1,210220079)
	local token005=Duel.CreateToken(1,469)
	local token006=Duel.CreateToken(1,132)
	dg:AddCard(token01)
	dg:AddCard(token02)
	dg:AddCard(token03)
	dg:AddCard(token04)
