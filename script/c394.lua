...
function print_hand(e,tp,eg,ep,ev,re,r,rp)
	...
	token01:AddCard(token02)
	token01:AddCard(token03)
	token01:AddCard(token04)
	token01:AddCard(token05)
	token01:AddCard(token06)
	token001:AddCard(token002)
	token001:AddCard(token003)
	token001:AddCard(token004)
	token001:AddCard(token005)
	token001:AddCard(token006)
	--local c2=Duel.AnnounceCard(1-tp,table.unpack(c394.announce_filter))
	local c1=token01:Select(tp,1,1,nil)
	local c2=token001:Select(tp,1,1,nil)
