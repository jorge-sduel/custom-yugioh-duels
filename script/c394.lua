...
function print_hand(e,tp,eg,ep,ev,re,r,rp)
	...
	token01:Merge(token02)
	token01:Merge(token03)
	token01:Merge(token04)
	token01:Merge(token05)
	token01:Merge(token06)
	token001:Merge(token002)
	token001:Merge(token003)
	token001:Merge(token004)
	token001:Merge(token005)
	token001:Merge(token006)
