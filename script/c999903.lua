...
function c999903.initial_effect(c)
	...
	e1:SetTarget(c999903.target)
	e1:SetOperation(c999903.activate)
	c:RegisterEffect(e1)
	--Activate
	...
	e2:SetTarget(c999903.target1)
	e2:SetOperation(c999903.activate1)
	c:RegisterEffect(e2)
end
function c999903.filter(c)
	return c:IsSetCard(0x344) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
function c999903.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c999903.filter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c999903.activate(e,tp,eg,ep,ev,re,r,rp)
