...
function c12727119.efilter(e,te)
	return te:GetOwnerPlayer()~=e:GetHandlerPlayer() and te:IsActiveType(TYPE_MONSTER)
end
function c12727119.tg(e,c)
	return c:IsSetCard(0x21) or c:IsSetCard(0x93db)
end
...
function c12727119.filter(c)
	return (c:IsSetCard(0x21) or c:IsSetCard(0x93db))  and c:IsAbleToHand()
end
