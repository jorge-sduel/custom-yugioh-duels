...
function c70934111.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(70934111,0))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e2:SetTarget(c70934111.placetg)
	e2:SetOperation(c70934111.placeop)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e5:SetDescription(aux.Stringid(70934111,1))
	e5:SetCode(EFFECT_SEND_REPLACE)
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e5:SetProperty(EFFECT_FLAG_SINGLE_RANGE+EFFECT_FLAG_UNCOPYABLE)
	e5:SetRange(LOCATION_MZONE)
	e5:SetTarget(c70934111.crystaltg)
	e5:SetOperation(c70934111.crystalop)
	c:RegisterEffect(e5)
end
function c70934111.crystaltg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c70934111.crystalop(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
...
function c70934111.placetg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c70934111.placeop(e,tp,eg,ep,ev,re,r,rp,chk)
