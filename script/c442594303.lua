...
function cid.initial_effect(c)
	...
	c:EnableReviveLimit()
	Xyz.AddProcedure(c,nil,10,2, aux.FilterBoolFunctionEx(Card.IsCode,221594309))
    --Send to GY
 ...
 e4:SetType(EFFECT_TYPE_SINGLE)  e4:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE) 
