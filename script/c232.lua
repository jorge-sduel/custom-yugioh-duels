...
function s.initial_effect(c)
	--xyz summon
	c:EnableReviveLimit()
		s.xyz_filter=function(mc,ignoretoken,xyz,tp) return mc and (not f or f(mc,xyz,SUMMON_TYPE_XYZ|MATERIAL_XYZ,tp)) and ((not 7 or mc:IsXyzLevel(c,7) or mc:c:GetFlagEffect(511000189)==7) and (not mc:IsType(TYPE_TOKEN) or ignoretoken) end
