...
function c924363413.initial_effect(c)
	...
	--Rune Summon
	c:EnableReviveLimit()
	aux.AddRunicProcedure1(c,aux.FilterBoolFunction(Card.IsRace,RACE_SPELLCASTER),c924363413.matfilter,1,1)
	Runic.AddProcedure(c,aux.FilterBoolFunction(Card.IsRace,RACE_SPELLCASTER),c924363413.matfilter,1,1)
	--tohand
