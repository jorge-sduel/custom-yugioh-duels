...
function c55738802.initial_effect(c)
	--synchro summon
Synchro.AddProcedure(c,nil,1,1,Synchro.NonTuner(Card.IsSetCard,0x23),1,99)
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,1,55738802)
	--selfdes
	...
	e1:SetCondition(c55738802.descon1)
	c:RegisterEffect(e1)
	--atkup
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c55738802.descon2)
	e3:SetTarget(c55738802.destg)
	e3:SetOperation(c55738802.desop)
	c:RegisterEffect(e3)
end
function c55738802.descon1(e)
...
function c55738802.descon2(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp
end
