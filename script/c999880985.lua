...
function s.initial_effect(c)
    ...
    c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x3008),s.matfilter)
...
s.listed_series={0x3008,0x8}
s.material_setcode={0x8,0x3008}
function s.matfilter(c,fc,sumtype,tp)
	return c:IsSetCard(0x8,fc,sumtype,tp) and c:IsLevelAbove(5)
end
