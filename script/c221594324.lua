...
function cid.initial_effect(c)
	c:EnableReviveLimit()
	  --synchro summon
	--time leap procedure
Timeleap.AddProcedure(c,nil,1,1,function(e,c) return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),LOCATION_REMOVED,0)>=10 end,nil,nil,LOCATION_MZONE+LOCATION_HAND)
	c:EnableReviveLimit() 
