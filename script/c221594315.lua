...
function cid.op(e,tp,eg,ep,ev,re,r,rp)
	if #(Duel.GetFieldGroupCount(tp,LOCATION_ONFIELD,0)-c)==0 or not Duel.IsExistingMatchingCard(aux.OR(Card.IsFacedown,Card.IsSetCard),tp,LOCATION_ONFIELD,0,1,c,0xc97) then return end
	local ct=0
