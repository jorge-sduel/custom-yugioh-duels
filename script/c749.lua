...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e1:SetCondition(function(e,tc3) return tc3:IsType(TYPE_SYNCHRO) end)
		e1:SetValue(4)
		...
		e2:SetCondition(function(e,tc3) return tc3:IsType(TYPE_SYNCHRO) end)
		...
		e3:SetCondition(function(e,tc3) return tc3:IsType(TYPE_XYZ) end)
		tc:RegisterEffect(e3)
		local e12=Effect.CreateEffect(e:GetHandler())
		e12:SetType(EFFECT_TYPE_SINGLE)
		e12:SetCode(EFFECT_CHANGE_LEVEL_FINAL)
		e12:SetCondition(function(e,tc3) return tc3:IsType(TYPE_XYZ) end)
		e12:SetValue(7)
		...
		e4:SetCondition(function(e,tc3) return tc3:IsType(TYPE_FUSION) end)
		e4:SetValue(8)
		...
		e5:SetCondition(function(e,tc3) return tc3:IsType(TYPE_FUSION) end)
		...
		e6:SetCondition(function(e,tc3) return tc3:IsType(TYPE_SYNCHRO) end)
		e6:SetValue(4)
		...
		e7:SetCondition(function(e,tc3) return tc3:IsType(TYPE_SYNCHRO) end)
		...
		e8:SetCondition(function(e,tc3) return tc3:IsType(TYPE_XYZ) end)
		tc3:RegisterEffect(e8)
		local e11=Effect.CreateEffect(e:GetHandler())
		e11:SetType(EFFECT_TYPE_SINGLE)
		e11:SetCode(EFFECT_CHANGE_LEVEL_FINAL)
		e11:SetCondition(function(e,tc3) return tc3:IsType(TYPE_XYZ) end)
		e11:SetValue(7)
		...
		e9:SetCondition(function(e,tc3) return tc3:IsType(TYPE_FUSION) end)
		e9:SetValue(8)
		...
		e10:SetCondition(function(e,tc3) return tc3:IsType(TYPE_FUSION) end)
