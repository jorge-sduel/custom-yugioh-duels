...
function c888000016.initial_effect(c)
	...
	e0:SetCondition(c888000016.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
	--atkup
...
c888000016.material_setcode={0x8,0x3008}
c888000016.dark_calling=true
c888000016.listed_names={CARD_DARK_FUSION,58932615,21844576}
function c888000016.lizcon(e,tp,eg,ep,ev,re,r,rp)
