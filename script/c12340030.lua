...
function s.initial_effect(c)
	...
	p2:SetTarget(aux.TargetBoolFunction(Card.IsAttribute,ATTRIBUTE_WATER))
	p2:SetValue(200)
	c:RegisterEffect(p2)
    local p3=p2:Clone()
...
function s.spfilter(c,e,tp)
	return c:IsFaceup() and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
