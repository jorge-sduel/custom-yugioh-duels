--Sin The Winged Dragon of Ra (ANIME)
...
function c85264938.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c85264938.spfilter,c:GetControler(),LOCATION_HAND+LOCATION_GRAVE,0,1,nil)
end
function c85264938.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c85264938.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil)
