...
function s.initial_effect(c)
	...
	e2:SetCategory(CATEGORY_CHANGE_ATTACK)
...
function s.filter2(c,rk,e,tp,mc,pg)
	...
	return c:IsType(TYPE_XYZ) and mc:IsType(TYPE_XYZ,c,SUMMON_TYPE_XYZ,tp) and (c:IsRankAbove(rk+1) or c:IsRankBelow(rk*2)) and mc:IsCanBeXyzMaterial(c,tp)
