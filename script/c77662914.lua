...
function c77662914.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_MACHINE),7,2)
	c:EnableReviveLimit()
	--pendulum summon
...
function c77662914.sccon(e)
	...
	return not tc or (not tc:IsCode(98442213) and not tc:IsCode(98442212) and not tc:IsCode(38299892) and not tc:IsCode(38299891) and not tc:IsCode(77662914))
end
