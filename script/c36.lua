...
function c36.initial_effect(c)
	...
	e2:SetCountLimit(1)	
	e2:SetTarget(c36.target)
	e2:SetOperation(c36.operation)
	c:RegisterEffect(e2)
	--DESTROY
	...
	e3:SetCondition(c36.atkcon)
	e3:SetCost(c36.cost)
	e3:SetTarget(c36.atktg)
	e3:SetOperation(c36.atkop)
	c:RegisterEffect(e3)
	--selfdes
	...
	e4:SetCondition(c36.sdcon2)
	e4:SetOperation(c36.sdop)
	c:RegisterEffect(e4)
end
function c36.sdcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(36)==0
end
function c36.sdop(e,tp,eg,ep,ev,re,r,rp)	
	e:GetHandler():CopyEffect(48179391,RESET_EVENT+0x1fe0000)
	e:GetHandler():RegisterFlagEffect(36,RESET_EVENT+0x1fe0000,0,1)
end
function c36.atcon(e)
...
function c36.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c36.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return tp~=Duel.GetTurnPlayer()
end
function c36.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c36.atkop(e,tp,eg,ep,ev,re,r,rp)
