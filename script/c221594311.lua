...
function cid.initial_effect(c)
	...
	e4:SetCondition(function(e) return Duel.IsExistingMatchingCard(cid.cfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil) end)
	...
	e5:SetCondition(function(e,tp) return c:IsReason(REASON_EFFECT) and c:GetReasonPlayer()==1-tp end)
...
--
	...
	--e6:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x3c97))
	e6:SetValue(1000)
	c:RegisterEffect(e6)
end
