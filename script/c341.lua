...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x52) and not c:IsCode(id) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
