...
if not EVOLUTE_IMPORTED then Duel.LoadScript("proc_evolute.lua") end
	...
	c:EnableReviveLimit()
	Evolute.AddProcedure(c,c192051222.mfilter1,2,99,c192051222.rcheck)
...
function c192051222.rcheck(g,lc,sumtype,tp)
...
function c192051222.mfilter1(c)
	return  c:IsLevel(3) or c:IsRank(3) or c:IsLevel(6) or c:IsRank(6)
end
...
function c192051222.matcheck(e,c)
	...
	if g:IsExists(Card.IsRace,1,nil,RACE_DRAGON) then e:SetLabel(3) end
end
...
function c192051222.ctcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetCounter(0x111f)>=3 end
