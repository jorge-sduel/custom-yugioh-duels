...
function s.cfilter(c)
	return c:IsFaceup() and (c.Is_Neutrino or c:IsSetCard(0x7b))
end
...
function s.spfilter(c,e,tp)
	return c.Is_Neutrino or c:IsRace(RACE_DRAGON) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
