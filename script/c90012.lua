...
function cm.initial_effect(c)
    --"Fusion Materials"
    c:EnableReviveLimit()
    Fusion.AddProcMixRep(c,true,true,c90012.matfilter,1,99,aux.FilterBoolFunctionEx(Card.IsType,TYPE_PENDULUM))
    --"Multi Attack"
...
function c90012.matfilter(c)
    return c:IsType(TYPE_LINK) and c:IsSetCard(0x20aa)
end
