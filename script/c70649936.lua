...
function c70649936.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,nil,aux.NonTuner(Card.IsRace,RACE_DRAGON),1)
	c:EnableReviveLimit()
	--spsummon
...
function c70649936.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c70649936.spfilter,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_GRAVE,0,1,nil,e,tp) end
...
function c70649936.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c70649936.spfilter,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_GRAVE,0,1,1,nil,e,tp)
