...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) and ft>1 
			and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_DECK,0,3,nil,e,tp)
	end
...
function s.efilter(e,te)
	return not ((te:IsCode(467) or te:IsCode(493) or te:IsCode(12632096) or te:IsCode(68396121) or te:IsCode(39272762) or te:IsCode(48348921) or te:IsCode(1497) or te:IsCode(249001043)) or te:IsHasEffect(555))
end
