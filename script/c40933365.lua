...
function c40933365.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMixRep(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x19),2,2,40933355)
	--spsummon condition
...
function c40933365.spfilter1(c,tp)
	return c:IsCode(40933355) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(nil,true)
