...
function c956000670.initial_effect(c)
	...
	e2:SetCondition(c956000670.furycon)
	e2:SetValue(400)
	c:RegisterEffect(e2)
	--Turn into Crystal
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(956000670,0))
	e3:SetCode(EFFECT_SEND_REPLACE)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e3:SetProperty(EFFECT_FLAG_SINGLE_RANGE+EFFECT_FLAG_UNCOPYABLE)
	e3:SetRange(LOCATION_MZONE)
	e3:SetTarget(c956000670.crystaltg)
	e3:SetOperation(c956000670.crystalop)
	c:RegisterEffect(e3)
end
function c956000670.crystaltg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c956000670.crystalop(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
