...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		...
		return ft>-1 and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_PZONE+LOCATION_OVERLAY+LOCATION_ALL-LOCATION_MZONE,0,1,nil,e,tp,mg,mg2,ft)
	end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_PZONE+LOCATION_OVERLAY+LOCATION_ALL-LOCATION_MZONE)
end
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_PZONE+LOCATION_OVERLAY+LOCATION_ALL-LOCATION_MZONE,0,1,1,nil,e,tp,mg,mg2,ft)
