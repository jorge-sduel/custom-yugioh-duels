...
function Evolute.ConditionFilter(c,f,lc,tp)
	return (not f or f(c,lc,SUMMON_TYPE_SPECIAL,tp)) and ((c:IsLocation(LOCATION_MZONE) and c:IsFaceup()) or (c:IsHasEffect(16000820,tp) and c:IsLocation(LOCATION_HAND)) or not c:IsHasEffect(50031787,tp))
end
