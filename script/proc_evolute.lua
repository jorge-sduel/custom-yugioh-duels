...
function Evolute.AddProcedure(c,f,min,max,specialchk,opp,loc,send)
	...
	ea:SetRange(LOCATION_EXTRA+LOCATION_MZONE+LOCATION_GRAVE+LOCATION_REMOVED)
...
function Evolute.IsLocation(c,e,loc,loc1)
	...
	return (c:IsLocation(loc1) or c:IsHasEffect(16000820,tp)) and not c:IsType(TYPE_LINK)
end
