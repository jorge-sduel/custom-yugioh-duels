...
function c888000012.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcCode2(c,22160245,20721928,true,true)
	--lizard check
	local e0=Effect.CreateEffect(c)
	e0:SetType(EFFECT_TYPE_SINGLE)
	e0:SetCode(CARD_CLOCK_LIZARD)
	e0:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e0:SetCondition(c888000012.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
...
c888000012.listed_names={CARD_DARK_FUSION,58932615,21844576}
function c888000012.lizcon(e,tp,eg,ep,ev,re,r,rp)
