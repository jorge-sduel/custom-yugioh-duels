...
c:AddSetcodesRule(id,false,0xbb109)
	c:EnableReviveLimit()
	Bigbang.AddProcedure(c,Bigbang.Neutral,3,99,nil,nil,LOCATION_HAND,2)
	Bigbang.AddProcedure(c,Bigbang.Neutral,3,99)
...
function cid.disable(e,c)
	return (c:IsType(TYPE_EFFECT) or bit.band(c:GetOriginalType(),TYPE_EFFECT)==TYPE_EFFECT) and c.IsBigbang
end
...
function cid.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(cid.cfilter,tp,LOCATION_DECK,0,1,nil,lv) end
