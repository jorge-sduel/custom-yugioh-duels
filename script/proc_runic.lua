...
and (e:GetHandler():IsLocation(LOCATION_EXTRA) and Duel.GetLocationCountFromEx()>0) or ( not e:GetHandler():IsLocation(LOCATION_EXTRA) and Duel.GetLocationCountFromEx()>0)
            end
end
