...
function c123103.initial_effect(c)
	...
	e7:SetCondition(c123103.con)
	e7:SetValue(c123103.atlimit)
	c:RegisterEffect(e7)
end
...
function c123103.con(e)
	return Duel.IsExistingMatchingCard(Card.IsPosition,e:GetHandlerPlayer(),LOCATION_MZONE,0,2,nil,POS_FACEUP_ATTACK)
end
function c123103.tfilter(c,atk)
	return c:IsFaceup() and c:GetAttack()<atk
end
function c123103.atlimit(e,c)
	return c:IsFaceup() and not Duel.IsExistingMatchingCard(c123103.tfilter,c:GetControler(),LOCATION_MZONE,0,1,c,c:GetAttack())
end