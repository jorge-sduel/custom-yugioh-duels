...
function cid.sumlimit(e,c)
	return c:IsLocation(LOCATION_EXTRA) and not c.IsBigbang
end
...
function cid.spfilter(c,e,tp)
	return c:GetLeftScale()==4 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cid.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,cid.cfilter,tp,LOCATION_GRAVE,0,1,1,nil,tp,c)
...
function cid.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,Card.IsFaceup,tp,LOCATION_MZONE,0,1,1,nil,e:GetHandler())
end
