...
function c999900.spfilter(c,e,tp)
	return c:GetCode()~=70902743 and c:IsSetCard(0x344) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c999900.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c999900.spfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
