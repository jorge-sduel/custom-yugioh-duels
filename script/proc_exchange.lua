...
-- f: optional, filter for monsters for the Exchange Summon. (Not needed must be an Exchange Monster)
-- sp: optional, flag if special summon. nil/true => sp, false => not sp
-- location: optional, special summon location. Default LOCATION_HAND, if setted replaces the default
-- extracat: optional, eventual extra categories for the effect. (Not needed CATEGORY_TOHAND|CATEGORY_SPECIAL_SUMMON)
-- extrainfo: optional, eventual OperationInfo to be set in Target function for the extra operation.
-- extraop: optional, additiona operation to be performed.
