...
function s.sumcon(e,c,minc)
	...
	e:SetLabel(mi)
	return Duel.IsExistingMatchingCard(Card.IsCanChangePosition,c:GetControler,LOCATION_MZONE,LOCATION_MZONE,mi,nil) and Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
end
