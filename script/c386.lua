...
function s.sumcon(e,c,minc)
	...
	e:SetLabel(mi)
	return Duel.IsExistingMatchingCard(Card.IsCanChangePosition,tp,LOCATION_MZONE,LOCATION_MZONE,mi,nil) and Duel.GetLocationCount(e:GetControler(),LOCATION_MZONE)>0
end
