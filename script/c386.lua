...
function s.sumcon(e,c,minc)
	...
	e:SetLabel(mi)
	return Duel.IsExistingMatchingCard(Card.IsCanChangePosition,e:GetPlayer(),LOCATION_MZONE,LOCATION_MZONE,mi,nil) and Duel.GetLocationCount(e:GetHandler():GetControler(),LOCATION_MZONE)>0
end
