...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if not Duel.CheckLPCost(1-tp,c:GetAttack()) then
		Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,1,0,0)
	end
end
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if Duel.CheckLPCost(1-tp,c:GetAttack()) and Duel.SelectYesNo(1-tp,aux.Stringid(80764541,1)) then
			Duel.PayLPCost(1-tp,c:GetAttack())
...
function s.indes2(e,c)
	return not (c:IsSetCard(0x48) and c.xyz_number and c.xyz_number>=101 and c.xyz_number<=1000)
end
