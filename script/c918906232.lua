...
function c918906232.initial_effect(c)
	...
	--Rune Summon
	c:EnableReviveLimit()
	aux.AddRunicProcedure2(c,aux.FilterBoolFunction(Card.IsRace,RACE_SPELLCASTER),c918906232.matfilter,1,1,LOCATION_EXTRA+LOCATION_HAND)
	--tohand
