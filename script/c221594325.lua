...
if not EVOLUTE_IMPORTED then Duel.LoadScript("proc_evolute.lua") end
	...
	c:EnableReviveLimit()
	Evolute.AddProcedure(c,nil,3,99,nil,LOCATION_ONFIELD+LOCATION_HAND,LOCATION_HAND+LOCATION_MZONE,2)
...
function cid.disable(e,c)
	return (c:IsType(TYPE_EFFECT) or bit.band(c:GetOriginalType(),TYPE_EFFECT)==TYPE_EFFECT) and c.Is_Evolute
end
...
function cid.filter1(c,ft)
	...
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and c:CheckActivateEffect(false,false,false)
end
