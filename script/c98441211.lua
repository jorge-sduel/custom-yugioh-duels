...
function c98441211.initial_effect(c)
	c:EnableReviveLimit()
Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x9d),c98441211.matfilter)
	--fusion material
...
c98441211.listed_series={0x9d}
c98441211.material_setcode=0x9d
function c98441211.matfilter(c,lc,sumtype,tp)
	return c:IsAttribute(ATTRIBUTE_DIVINE,lc,sumtype,tp) or c:IsHasEffect(4904633)
end
function c98441211.ffilter1(c)
	return c:IsSetCard(0x9d)
end
function c98441211.ffilter2(c)
	return c:IsAttribute(ATTRIBUTE_DIVINE) or c:IsHasEffect(4904633)
end
