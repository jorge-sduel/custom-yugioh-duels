function c40933398.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMixRep(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x19),1,1,57731460)
	--spsummon condition
...
function c40933398.spfilter1(c,tp)
	return c:IsCode(57731460) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(nil,true)
