--クリアー・バイス・ドラゴン
function c113.initial_effect(c)
...
e3:SetProperty(EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_IGNORE_IMMUNE)
	...
	e3:SetOperation(c113.ctop)
	c:RegisterEffect(e3)
end
function c113.condtion(e)
	return Duel.GetCurrentPhase()==PHASE_DAMAGE_CAL
		and Duel.GetAttacker()==e:GetHandler() and Duel.GetAttackTarget()~=nil
end
function c113.atkval(e,c)
	return Duel.GetAttackTarget():GetAttack()
end
function c113.ctop(e,tp,eg,ep,ev,re,r,rp)
