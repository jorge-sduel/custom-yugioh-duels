...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetCondition(function(e) return s.PlayerIsAffectedByClearWorld(1-e:GetHandlerPlayer(),ATTRIBUTE_DARK) end)
	...
	e3a:SetCondition(function(e,tp) return s.PlayerControlsAttributeOrIsAffectedByClearWall(tp,ATTRIBUTE_EARTH+ATTRIBUTE_WIND) end)
	...
	e3c:SetCondition(function(e) return s.PlayerIsAffectedByClearWorld(1-e:GetHandlerPlayer(),ATTRIBUTE_EARTH+ATTRIBUTE_WIND) end)
	e3c:SetValue(s.atkval)
	c:RegisterEffect(e3c)
	local e3d=e3a:Clone()
	e3d:SetCode(EFFECT_SET_BASE_DEFENSE)
	e3d:SetTargetRange(0,LOCATION_MZONE)
	e3d:SetCondition(function(e) return s.PlayerIsAffectedByClearWorld(1-e:GetHandlerPlayer(),ATTRIBUTE_EARTH+ATTRIBUTE_WIND) end)
	...
	e4:SetCondition(function(e,tp) return s.PlayerControlsAttributeOrIsAffectedByClearWall(tp,ATTRIBUTE_WATER+ATTRIBUTE_FIRE) end)
	e4:SetCost(s.costchk)
	e4:SetOperation(s.costop)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	e5:SetCondition(function(e) return s.PlayerIsAffectedByClearWorld(1-e:GetHandlerPlayer(),ATTRIBUTE_WATER+ATTRIBUTE_FIRE) end)
	...
	c:RegisterEffect(e6)
	local e6a=e6:Clone()
	e6a:SetCondition(function(e) return s.PlayerControlsAttributeOrIsAffectedByClearWall(tp,ATTRIBUTE_DIVINE) or not s.PlayerControlsAttributeOrIsAffectedByClearWall(tp,ATTRIBUTE_ALL-ATTRIBUTE_DIVINE) end)
...
function s.PlayerControlsAttributeOrIsAffectedByClearWall(tp,attribute)
