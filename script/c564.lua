...
function s.spfilter(c,e,tp)
	return c:IsType(TYPE_FUSION) and c:IsCode(1546123) and not c:IsCode(id) and Duel.GetLocationCountFromEx(tp,tp,nil,c)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
