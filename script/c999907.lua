...
function c999907.negop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(999907,RESET_EVENT+0x1fe0000+RESET_PHASE+RESET_END,0,0)
end
...
function c999907.spfilter(c,e,tp)
	return c:IsCode(70902743) or c:IsSetCard(0x344) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
